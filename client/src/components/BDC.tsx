    ...
    return (
        <section className=' mt-36'>
            <div className='flex flex-col bg-red-400 p-4 lg:p-12 text-white justify-center items-center'>
                ...
                <span className='text-sm xl:text-xl'>contact Redcross Nepal <a className='cursor-pointer font-bold underline' href="https://nrcs.org/contact/"><LinkIcon /> click here</a></span>
            </div>
            <h2 className=' text-slate-400 font-bold border-b-2 border-t-2 mt-28 mb-4 text-xl xl:text-3xl text-center'><QuestionAnswerIcon /> Some common Q&A's</h2>
